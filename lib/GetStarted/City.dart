              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    mainText("Select Your City", mainColor, 35.0,
                        FontWeight.normal, 1),
                    SizedBox(
                      height: 80.0,
                    ),
...
class listItems extends StatefulWidget {
  String title;
  String name;
  listItems({Key? key, required this.title, required this.name})
      : super(key: key);
...
class _listItemsState extends State<listItems> {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      onPressed: () {
        navScreen(college(data: {'city': widget.title, 'name': widget.name}),
            context, false);
      },
    );
  }
