...
class enterOTP extends StatefulWidget {
  String number;
  String vID;
  enterOTP({Key? key, required this.number, required this.vID})
      : super(key: key);
...
class _enterOTPState extends State<enterOTP> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        mainText(
                            "Enter OTP", mainColor, 35.0, FontWeight.normal, 1),
                        Spacer()
                      ],
                    ),
                    Row(
                      children: [
                        mainText("we have send OTP on your number", secColor,
                            13.0, FontWeight.normal, 1),
                        Spacer(),
                      ],
                    ),
                    SizedBox(
  ...
  Future LoginwithOTP() async {
    ...
    var _cred =
        PhoneAuthProvider.credential(verificationId: widget.vID, smsCode: OTP);
    _auth
